      ...
      if (this.props.addedField[0].uiElement === "Text Field") {
        return (
          ...
          <div className="ui card" style={rectangle1}>
              <p onClick={() => this.props.delete(this.props.id)}>
                delete
              </p>
           </div>
          <div style={addField} id={this.props.id} onClick={displayRect} >
            <span><i class="asterisk icon" style={asterisk}></i>
            <label style={labelD} htmlFor={this.props.addedField[0].id}>
              {this.props.addedField[0].label}
            </label>
            <input style={iconic} type={this.props.addedField[0].data_type} />
</span>
        ...
        return (
          ...
          <div style={addField} id={this.props.id}>
            ...
            <input style={iconic7} type={this.props.addedField[0].data_type} />
          </div>
          </div>
        );
      }
